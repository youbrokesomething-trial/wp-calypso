...
export const ALL_DOMAINS_TEST_REQUEST = 'ALL_DOMAINS_TEST_REQUEST';
export const ALL_DOMAINS_TEST_REQUEST_FAILURE = 'ALL_DOMAINS_TEST_REQUEST_FAILURE';
export const ALL_DOMAINS_TEST_REQUEST_SUCCESS = 'ALL_DOMAINS_TEST_REQUEST_SUCCESS';
